...
- (void)setScrollView:(UIScrollView *)scrollView
{
    ...
    // 设置边框
    self.frame = CGRectMake(0, -kInsetsTop, scrollView.frame.size.width, kViewHeight);
	...
	switch (_state = state) {
		...
		case RefreshStateRefreshing:
        {
            ...
            [UIView animateWithDuration:0.2 animations:^{
                ...
                _scrollView.contentInset = inset;
                // 2.设置滚动位置
                _scrollView.contentOffset = CGPointMake(0, -kRefreshHeight);
            }];
			break;
        }
	}
