...
- (void)setScrollViewContentInset:(UIEdgeInsets)contentInset {
    [UIView animateWithDuration:0.3
                     ...
                     animations:^{
//                         contentInset.top=0;
                         NSLog(@"top:%f",contentInset.top);
                         UIEdgeInsets newContent=contentInset;
                         if (newContent.top==0) {
                             newContent=UIEdgeInsetsMake(64, contentInset.left, contentInset.bottom, contentInset.right);
                         }
                         self.scrollView.contentInset = newContent;
...
- (void)doAnimationStepForRandomWaitingAnimation {
    ...
    for (int i=0; i<self.particles.count; i++) {
        ...
        particleView.backgroundColor = (i == idx) ? [UIColor grayColor] : [UIColor darkGrayColor];
    }
}
...
- (void)doAnimationStepForLinearWaitingAnimation {        
    ...
    for (int i=0; i<self.particles.count; i++) {
        ...
        if (particleView.backgroundColor == [UIColor grayColor]) {
            startIdx = i;
            break;;
        }
    }
    ...
    for (int i=0; i<self.particles.count; i++) {
        ...
        if (i == prevIdx) {
            ...
            particleView.backgroundColor = [UIColor grayColor];
        } else {
