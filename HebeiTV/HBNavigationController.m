...
- (void)viewDidLoad
{
    ...
    UIImageView *shadowImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"背景图（颜色#f2f7f8）"]];
...
//    self.navigationBar.tintColor=[UIColor colorWithRed:250.0/255.0 green:250.0/255.0 blue:250.0/255.0 alpha:0.9];
