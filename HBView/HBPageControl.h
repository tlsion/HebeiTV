...
typedef enum {
	HBPageControlAlignmentLeft = 1,
	HBPageControlAlignmentCenter,
	HBPageControlAlignmentRight
}HBPageControlAlignment;

typedef enum {
	HBPageControlVerticalAlignmentTop = 1,
	HBPageControlVerticalAlignmentMiddle,
	HBPageControlVerticalAlignmentBottom
}HBPageControlVerticalAlignment;

@interface HBPageControl : UIControl
...
@property (nonatomic) HBPageControlAlignment alignment					UI_APPEARANCE_SELECTOR; // deafult is Center
@property (nonatomic) HBPageControlVerticalAlignment verticalAlignment	UI_APPEARANCE_SELECTOR;	// deafult is Middle
